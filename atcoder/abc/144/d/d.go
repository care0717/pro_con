...
func main() {
	...
	if float64(a*a*b)/2 > float64(x) {
		fmt.Println(90 - 360*math.Atan(float64(2*x)/float64(a*b*b))/(2*math.Pi))
	} else {
		fmt.Println(90 - 360*math.Atan(float64(a*a*a)/float64(2*(a*a*b-x)))/(2*math.Pi))
